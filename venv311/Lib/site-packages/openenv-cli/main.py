...
class ExamplenameError(Exception):
    """Base exception for openenv-cli errors."""
    pass
...
class Client:
    """
    The primary interface for the openenv-cli service.
    
    Usage:
        >>> from openenv-cli import Client
    ...
    def connect(self) -> bool:
        ...
        print(f"[+] openenv-cli: Connected with session {self._session_id}")
        return True
    ...
    def disconnect(self):
        ...
        print("[-] openenv-cli: Connection closed.")
